...
# --- प्रिमियम डार्क आणि लाईट थीम CSS ---
st.markdown("""
<style>
...
<div class="vp-card">
    ...
    <ul class="vp-list">
        ...
        <li class="vp-list-item"><strong>Imp प्रश्नांचे अचूक वर्गीकरण:</strong> Board परीक्षेत वारंवार रिपीट होणारे प्रश्न आमचे ऍडव्हान्स जेमिनी AI मॉडेल एका क्लिकवर अचूक शोधून देते.</li>
